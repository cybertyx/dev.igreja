...
<div class="form-row">
    <div class="form-label col-md-2">
        <label for="">
            É administrador?:<span class="required"> *</span><!----------------------------------------------------------------------------->
        </label>
    </div>
    <div class="form-input col-md-8 {{$errors->has('nivel') ? ' has-error' : ''}}">
        {!!Form::checkbox('nivel', 'value', 0, ['class' => 'parsley-validated', 'placeholder' => 'Nome do Membro'])!!}
    </div>
</div>
@endif
<div class="form-row">
    ...
    <div class="form-input col-md-8 {{$errors->has('name') ? ' has-error' : ''}}">
        {!!Form::text('name', null, ['class' => 'parsley-validated', 'placeholder' => 'Nome do Membro'])!!}
    </div>
</div>
<div class="form-row">
    <div class="form-label col-md-2">
    ...
    <div class="form-input col-md-8">
        {!!Form::text('email', null, ['class' => 'parsley-validated', 'placeholder' => 'Email do Membro'])!!}
    </div>
</div>
<div class="form-row">
    <div class="form-label col-md-2">
    ...
    <div class="form-input col-md-8">
        {!!Form::password('password', null, ['class' => 'parsley-validated', 'placeholder' => 'Senha do Membro'])!!}
    </div>
</div>
<div class="form-row">
    <div class="form-label col-md-2">
    ...
    <div class="form-input col-md-8">
        {!!Form::password('password-confirm', null, ['class' => 'parsley-validated', 'placeholder' => 'Confirmar Senha do Membro'])!!}
    </div>
</div>
<div class="form-row">
    <div class="form-label col-md-2">
